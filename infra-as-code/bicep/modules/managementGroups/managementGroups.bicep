...
// Simplified logic: Start with empty, then union based on enabled features
var varLandingZoneBaseChildren = parLandingZoneMgAlzDefaultsEnable ? varLandingZoneMgChildrenAlzDefault : {}
var varLandingZoneConfidentialChildren = parLandingZoneMgConfidentialEnable ? varLandingZoneMgChildrenConfidential : {}
var varLandingZoneCustomChildren = !empty(parLandingZoneMgChildren) ? parLandingZoneMgChildren : {}
var varLandingZoneMgChildrenUnioned = union(varLandingZoneBaseChildren, varLandingZoneConfidentialChildren, varLandingZoneCustomChildren)

// Simplified logic for Platform Management Groups
var varPlatformBaseChildren = parPlatformMgAlzDefaultsEnable ? varPlatformMgChildrenAlzDefault : {}
var varPlatformCustomChildren = !empty(parPlatformMgChildren) ? parPlatformMgChildren : {}
var varPlatformMgChildrenUnioned = union(varPlatformBaseChildren, varPlatformCustomChildren)
